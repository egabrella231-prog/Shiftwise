...
import { Users, Calendar, Clock, AlertCircle, Sparkles, Send, FileSpreadsheet, Share2 } from 'lucide-react';
      ...
      <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-xs">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          ...
          <button 
            ...
            className="flex flex-col items-center justify-center p-4 bg-green-50 border border-green-100 hover:border-[#25D366] text-green-800 rounded-xl transition cursor-pointer text-center"
          >
            <Share2 className="h-6 w-6 text-[#25D366] mb-2" />
            <span className="font-bold text-xs">Share to WhatsApp</span>
            <span className="text-[10px] text-green-600 mt-1">Sends roster summary</span>
          </button>
        </div>
      </div>
    </div>
